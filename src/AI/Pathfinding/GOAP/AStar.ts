...
module ai {
    export class AStarNode implements es.IEquatable<AStarNode>, es.IPoolable {
        /**
         * 这个节点的世界状态
         */
    ...
    export class AStar {
        ...
        public static plan(ap: ActionPlanner, start: WorldState, goal: WorldState, selectedNodes: AStarNode[] = null){
            ...
            let currentNode = es.Pool.obtain<AStarNode>(AStarNode);
            ...
            while(true){
                ...
                for (let i = 0; i < neighbors.length; i++){
                    ...
                    if (opened == null && closed == null){
                        let nb = es.Pool.obtain<AStarNode>(AStarNode);
